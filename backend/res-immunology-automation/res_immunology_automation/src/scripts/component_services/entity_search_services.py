...
gene_db_file_path= "/app/geneSearch/duckdb.db"
...
def lexical_phenotype_search(search_string: str, conn: DuckDBPyConnection) -> DataFrame:
   ...
   """
   query = f"({primary_phenotype_query}) UNION ALL ({fts_phenotype_query}) UNION ALL ({secondary_phenotype_query}) UNION ALL ({substring_phenotype_query})"
