...
const IndicationsSummary: React.FC<IndicationsSummaryProps> = ({ indicationData }) => {
  ...
  return (
    <div className="mb-10">
      ...
      <p>* The failed entries for the targets include trials that were withdrawn or terminated due to unmet endpoints, financial constraints, or other factors. For detailed explanations, please refer to the respective trial ID from the "List of Trials by Target" table.</p>
      {summaryData && (
